...
public class ImageCacheUtil implements ImageCache {
    ...
    public ImageCacheUtil() {
        ...
        try {
            // 获取DiskLruCahce对象
            mDiskLruCache = DiskLruCache.open(getDiskCacheDir(App.getInstance(), "Rabbit"), getAppVersion(App.getInstance()), 1, DISKMAXSIZE);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        Log.d("Filepath=============",cachePath + File.separator + uniqueName);
