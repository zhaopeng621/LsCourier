...
public class OrdersCanceledFragment extends Fragment implements XRecyclerView.LoadingListener{
    ...
    public OrdersCanceledFragment(List<OrderEntry> datas) {
        super();
        this.datas = datas;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.main_orders_canceled_fragment, container, false);
        }
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        recyclerView = (XRecyclerView) view.findViewById(R.id.recycleview4);
        ...
        if (datas.size() > 0) {
            ...
            Log.d("recycleview4",String.valueOf(datas.size()));
        } else {
