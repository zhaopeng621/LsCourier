...
public class OrderInProgressFragment extends Fragment implements XRecyclerView.LoadingListener{
    ...
    public OrderInProgressFragment(List<OrderEntry> datas) {
        super();
        this.datas = datas;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.main_order_in_progress_fragment, container, false);
        }
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        recyclerView = (XRecyclerView) view.findViewById(R.id.recycleview2);
        ...
        if (datas.size() > 0) {
            ...
            Log.d("recycleview2",String.valueOf(datas.size()));
        } else {
